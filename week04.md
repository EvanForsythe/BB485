...
- Answer the following questions and submit as a word doc (or similar) on Canvas:
   ...
   2. Write a "Methods Section" (~3-4 sentances) describing the analysis. Which steps did you run as part of SLURM job submissions? Which steps did you run directly from the command line?
